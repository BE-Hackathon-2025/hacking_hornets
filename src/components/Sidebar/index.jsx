          ...
          <div>
            ...
            <li>
              ...
              >
                ...
                >
                  <path
                    d="M16.5 8.25V16.5H11.25V11.25H6.75V16.5H1.5V8.25H0L9 0L18 8.25H16.5ZM13.5 16.5V7.9425L9 3.93L4.5 7.9425V16.5H7.5V10.5H10.5V16.5H13.5Z"
                    fill=""
                  />
                </svg>
                Home
              ...
              <li>
                <NavLink
                  to="/ai"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('ai') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                  ...
                  >
                    ...
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M9 4V3C9 2.44772 9.44772 2 10 2H14C14.5523 2 15 2.44772 15 3V4H17C18.1046 4 19 4.89543 19 6V9H20C20.5523 9 21 9.44772 21 10V14C21 14.5523 20.5523 15 20 15H19V18C19 19.1046 18.1046 20 17 20H15V21C15 21.5523 14.5523 22 14 22H10C9.44772 22 9 21.5523 9 21V20H7C5.89543 20 5 19.1046 5 18V15H4C3.44772 15 3 14.5523 3 14V10C3 9.44772 3.44772 9 4 9H5V6C5 4.89543 5.89543 4 7 4H9ZM7 6H17V18H7V6ZM10 14C10 14.5523 10.4477 15 11 15H13C13.5523 15 14 14.5523 14 14V13C14 12.4477 13.5523 12 13 12H11C10.4477 12 10 12.4477 10 13V14Z"
                      fill=""
                    />
                  </svg>
                  AI
